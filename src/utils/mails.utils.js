...
exports.sendEmailVerificationMail = async (userEmail, token, role) => {
  const mailOptions = {
    ...
    html: `<p>Welcome to SkillApp- you're almost ready to get started with your account!</p>
            <p> But first, we need to verify your email. Please click <a href=${redirectionBaseUrl}user/auth/verify-email/${token}?role=${role}>on this link</a> to verify your email.</p>
...
exports.sendForgotPasswordMail = async (email, resetPasswordToken) => {
  const mailOptions = {
    ...
    text: `You are receiving this email because you (or someone else) have requested the reset of the password for your account.\n\n
        ...
        https://${redirectionBaseUrl}/reset-password/${resetPasswordToken}\n\n
