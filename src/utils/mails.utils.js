...
exports.sendEmailVerificationMailTest = (
  userEmail,
  token,
  role
) => `<p>Welcome to SkillApp- you're almost ready to get started with your account!</p>
...
exports.sendForgotPasswordMail = async (email, resetPasswordToken) => {
  const mailOptions = {
    ...
    text: `You are receiving this email because you (or someone else) have requested the reset of the password for your account.\n\n
        ...
        <a href="${redirectionBaseUrl}auth/reset-password/${resetPasswordToken}">${redirectionBaseUrl}auth/reset-password/${resetPasswordToken}</a>\n\n
